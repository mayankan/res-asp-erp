<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="6TERM2.aspx.cs" Inherits="RAINBOW_ERP.ReportCard._2019._6TERM2" %>
            ...
            <table width="100%" style="table-layout: fixed">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><asp:Label ID="lblSanskritPT" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSanskritNS" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSanskritSEA" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSanskritTerm1" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSanskritTotalTerm1" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSanskritPT2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSanskritNS2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSanskritSEA2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSanskritTerm2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSanskritTotalTerm2" runat="server"></asp:Label></td>
                        <td colspan="2" style="text-align: center"><asp:Label ID="lblSanskritTotal" runat="server"></asp:Label></td>
                        <td colspan="2" style="text-align: center"><asp:Label ID="lblSanskritGrade" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="strong">
                            <p>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><asp:Label ID="lblSciencePT" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblScienceNS" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblScienceSEA" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblScienceTerm1" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblScienceTotalTerm1" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSciencePT2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblScienceNS2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblScienceSEA2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblScienceTerm2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblScienceTotalTerm2" runat="server"></asp:Label></td>
                        <td colspan="2" style="text-align: center"><asp:Label ID="lblScienceTotal" runat="server"></asp:Label></td>
                        <td colspan="2" style="text-align: center"><asp:Label ID="lblScienceGrade" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="strong">
                            <p>
                        ...
                        <td style="text-align: center"><asp:Label ID="lblSocialSciencePT" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSocialScienceNS" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSocialScienceSEA" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSocialScienceTerm1" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSocialScienceTotalTerm1" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSocialSciencePT2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSocialScienceNS2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSocialScienceSEA2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSocialScienceTerm2" runat="server"></asp:Label></td>
                        <td style="text-align: center"><asp:Label ID="lblSocialScienceTotalTerm2" runat="server"></asp:Label></td>
                        <td colspan="2" style="text-align: center"><asp:Label ID="lblSocialScienceTotal" runat="server"></asp:Label></td>
                        <td colspan="2" style="text-align: center"><asp:Label ID="lblSocialScienceGrade" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="strong">
                            <p>
