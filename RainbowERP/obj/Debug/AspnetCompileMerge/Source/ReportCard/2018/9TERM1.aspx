<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="9TERM1.aspx.cs" Inherits="RAINBOW_ERP.ReportCard._2018._9TERM1" %>
        ...
        <div style="border: 1px solid black;">
            ...
            <table style="width: 100%; height: 400px" border="1" cellspacing="0" cellpadding="0" align="center">
                <tbody>
                    ...
                    <tr style="border: 1px solid black;">
                        <td><strong>Subject Name</strong></td>
                        <td colspan="2"><strong>Theory (50)</strong></td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" width="86" style="text-align: center"><asp:Label ID="lblITTheory" runat="server"></asp:Label></td>
                        <td colspan="2" width="108" style="text-align: center"><asp:Label ID="lblITPractical" runat="server"></asp:Label></td>
                        <td width="132" style="text-align: center"><asp:Label ID="lblITTotal" runat="server"></asp:Label></td>
