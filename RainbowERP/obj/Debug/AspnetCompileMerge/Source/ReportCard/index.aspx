<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="RAINBOW_ERP.ReportCard.index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
        ...
        <br />
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnAddMarks" runat="server" Text="Enter Marks" OnClick="btnAddMarks_Click" />
        <br />
        <br />
 <span style="float:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EXAMINATION NAME&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;<asp:TextBox ID="ftExaminationName" runat="server" Width="149px" style="float:left;"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        <asp:GridView ID="grdMarks" AutoGenerateColumns="False" runat="server" AllowSorting="True" OnSorting="grdMarks_Sorting" CellPadding="1" ForeColor="#333333" EmptyDataText="No data available." OnRowCommand="grdMarks_RowCommand" OnPageIndexChanging="grdMarks_PageIndexChanging" AllowPaging="true" PageSize="20">
