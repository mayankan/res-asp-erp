<%@ Page Title="" Language="C#" MasterPageFile="../ERP.Master" AutoEventWireup="true" CodeBehind="ManageSC.aspx.cs" Inherits="RAINBOW_ERP.Student.ManageSC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
        ...
        <p>
            ...
            <asp:TextBox ID="txtSCName" runat="server" Width="149px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="valSCName" runat="server" ErrorMessage="*" ControlToValidate="txtSCName" ForeColor="Red" ValidationGroup="Required"></asp:RequiredFieldValidator>
        <br />
