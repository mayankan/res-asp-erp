<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="6TERM1.aspx.cs" Inherits="RAINBOW_ERP.ReportCard.Out._6TERM1" %>
            ...
            <table style="width: 100%; height:1200px" border="1" cellspacing="0" cellpadding="0" align="center">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2" width="132" style="text-align: center"><asp:Label ID="lblSanskritTotal" runat="server"></asp:Label></td>
                    ...
                    <tr>
                        ...
                        <td width="86" style="text-align: center"><asp:Label ID="lblGKPT" runat="server"></asp:Label></td>
                        <td width="102" style="text-align: center"><asp:Label ID="lblGKNS" runat="server"></asp:Label></td>
                        <td width="114" style="text-align: center"><asp:Label ID="lblGKSEA" runat="server"></asp:Label></td>
                        <td width="108" style="text-align: center"><asp:Label ID="lblGKTerm1" runat="server"></asp:Label></td>
                        <td colspan="2" width="132" style="text-align: center"><asp:Label ID="lblGKTotal" runat="server"></asp:Label></td>
                        <td width="103" style="text-align: center"><asp:Label ID="lblGKGrade" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
