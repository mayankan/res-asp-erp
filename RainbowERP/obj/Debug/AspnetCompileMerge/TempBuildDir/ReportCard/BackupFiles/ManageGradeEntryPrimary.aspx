<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" CodeBehind="ManageGradeEntryPrimary.aspx.cs" Inherits="RAINBOW_ERP.ReportCard.GradeEntryPrimary" %>
                ...
                <asp:TemplateField HeaderText="Grade">
                    ...
                    <ItemTemplate>
                        <asp:DropDownList AppendDataBoundItems="true" ID="ddlGrades" runat="server" DataTextField="name" DataValueField="id">
                            ...
                            <asp:ListItem Value="D">D Grade</asp:ListItem>
                        </asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>
