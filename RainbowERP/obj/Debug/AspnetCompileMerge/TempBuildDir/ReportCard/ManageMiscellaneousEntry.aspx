<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" CodeBehind="ManageMiscellaneousEntry.aspx.cs" Inherits="RAINBOW_ERP.ReportCard.ManageMiscellaneousEntry" %>
        ...
        <asp:GridView ID="grdStudent" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="0" ForeColor="#333333" GridLines="None" EmptyDataText="No data available." OnRowDataBound="grdStudent_RowDataBound" Width="100%">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Remarks">
                    ...
                    <ItemTemplate>
                        <asp:TextBox TextMode="MultiLine" ID="txtRemarks" runat="server">
                        </asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
