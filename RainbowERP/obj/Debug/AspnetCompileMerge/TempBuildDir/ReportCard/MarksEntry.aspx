<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" CodeBehind="MarksEntry.aspx.cs" Inherits="RAINBOW_ERP.ReportCard.MarksEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
        <asp:GridView ID="grdStudent" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="1" GridLines="None" EmptyDataText="No data available." OnRowDataBound="grdStudent_RowDataBound" Width="100%">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Marks">
                    ...
                    <ItemTemplate>
                        <asp:TextBox AppendDataBoundItems="true" ID="txtMarks" runat="server" DataTextField="name" DataValueField="id">
                        </asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
