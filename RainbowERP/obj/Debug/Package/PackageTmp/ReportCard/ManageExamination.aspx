<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" CodeBehind="ManageExamination.aspx.cs" Inherits="RAINBOW_ERP.ReportCard.ManageExamination" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
        <p>
            Examination Name&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="txtExamination" runat="server" Width="149px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="valExamination" runat="server" ErrorMessage="*" ControlToValidate="txtExamination" ForeColor="Red" ValidationGroup="Required"></asp:RequiredFieldValidator>
            <br />
            Student Class&nbsp;&nbsp;&nbsp;&nbsp;
