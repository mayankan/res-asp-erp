<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" CodeBehind="ManageClassSubjectMap.aspx.cs" Inherits="RAINBOW_ERP.ReportCard.ManageClassSubjectMap" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section style="float: left; width: 50%">
        <p>
            ...
            <br />
            Subject 1&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="txtSubject1" runat="server" Width="149px">
    ...
    <section style="width: 100%; float: left">
        <asp:Label ID="lblUpdate" runat="server"></asp:Label><br />
