<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="4TERM2.aspx.cs" Inherits="RAINBOW_ERP.ReportCard.Out._4TERM2" %>
            ...
            <table style="width: 100%; height: 1200px" border="1" cellspacing="0" cellpadding="0" align="center">
                <tbody>
                    <tr>
                        ...
                        <td colspan="5">
                            <p><strong>C. Social Science</strong></p>
                        </td>
                        <td>
                            <p><strong>Term 1</strong></p>
                        </td>
                    ...
                    <tr>
                        ...
                        <td rowspan="2">
                            <p>
                                <asp:Label ID="lblSocialConceptTerm1" runat="server"></asp:Label>
                            </p>
                            <p>
                                <asp:Label ID="lblSocialActivityTerm1" runat="server"></asp:Label>
                            </p>
                            <p>
                                <asp:Label ID="lblSocialGDTerm1" runat="server"></asp:Label>
                            </p>
                            <p>
                                <asp:Label ID="lblSocialWrittenWorkTerm1" runat="server"></asp:Label>
                            </p>
                        </td>
                        <td rowspan="2">
                            <p>
                                <asp:Label ID="lblSocialConceptTerm2" runat="server"></asp:Label>
                            </p>
                            <p>
                                <asp:Label ID="lblSocialActivityTerm2" runat="server"></asp:Label>
                            </p>
                            <p>
                                <asp:Label ID="lblSocialGDTerm2" runat="server"></asp:Label>
                            </p>
                            <p>
                                <asp:Label ID="lblSocialWrittenWorkTerm2" runat="server"></asp:Label>
                            </p>
                        </td>
                    </tr>
                    <tr>
