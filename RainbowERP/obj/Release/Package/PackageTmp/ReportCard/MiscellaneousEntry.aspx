<%@ Page Title="" Language="C#" MasterPageFile="~/ERP.Master" AutoEventWireup="true" CodeBehind="MiscellaneousEntry.aspx.cs" Inherits="RAINBOW_ERP.ReportCard.MiscellaneousEntry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- Header -->
    <header id="header">
        <strong>Manage Miscellaneous Entry</strong>
        <%--<ul class="icons">
    ...
    <section>
        ...
        <br />
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnAddMisc" runat="server" Text="Enter Remarks & Attendance" OnClick="btnAddMisc_Click" />
        <br />
        <br />
 <span style="float:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EXAMINATION NAME&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;<asp:TextBox ID="ftExaminationName" runat="server" Width="149px" style="float:left;"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <br />
        <asp:GridView ID="grdMisc" AutoGenerateColumns="False" runat="server" AllowSorting="True" OnSorting="grdMisc_Sorting" CellPadding="1" ForeColor="#333333" EmptyDataText="No data available." OnRowCommand="grdMisc_RowCommand" OnPageIndexChanging="grdMisc_PageIndexChanging" AllowPaging="true" PageSize="20">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="">
                    <ItemTemplate>
                        <asp:Button runat="server" Text="Edit" CommandName="Select" CommandArgument='<%#Eval("classId")+"-"+ Eval("examinationId")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
